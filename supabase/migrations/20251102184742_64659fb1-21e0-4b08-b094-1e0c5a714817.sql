-- FASE 1: Sistema de Validação Admin

-- 1. Adicionar colunas de validação em user_challenge_progress
...
CREATE INDEX idx_user_challenge_admin_validated 
ON public.user_challenge_progress(admin_validated, user_id);

-- 3. Atualizar trigger para considerar apenas desafios validados
...
-- FASE 3: Atualizar Grupos de Participação

-- Atualizar o grupo "Influenciadores" para "Delivery"
UPDATE public.social_challenge_groups
SET 
  name = 'Delivery',
  icon_emoji = '🛵',
  slug = 'delivery',
  description = 'Profissionais de entrega de aplicativos'
WHERE slug = 'influenciadores';

-- Se não existir, criar
INSERT INTO public.social_challenge_groups (group_number, name, icon_emoji, slug, description)
VALUES (11, 'Delivery', '🛵', 'delivery', 'Profissionais de entrega de aplicativos')
